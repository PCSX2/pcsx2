...
// FIXME
                ...
                if (pad->mode != MODE_DIGITAL) { // ANALOG || DS2 native
                    ...
                    if (pad->mode != MODE_ANALOG) { // DS2 native
                        ...
                        query.response[9] = !test_bit(buttons, 13) ? buttons, PAD_RIGHT : 0;
                        query.response[10] = !test_bit(buttons, 15) ? buttons, PAD_LEFT : 0;
                        query.response[11] = !test_bit(buttons, 12) ? buttons, PAD_UP : 0;
                        query.response[12] = !test_bit(buttons, 14) ? buttons, PAD_DOWN : 0;
                        query.response[13] = !test_bit(buttons, 4) ? buttons, PAD_TRIANGLE : 0;
                        query.response[14] = !test_bit(buttons, 5) ? buttons, PAD_CIRCLE : 0;
                        query.response[15] = !test_bit(buttons, 6) ? buttons, PAD_CROSS : 0;
                        query.response[16] = !test_bit(buttons, 7) ? buttons, PAD_SQUARE : 0;
                        query.response[17] = !test_bit(buttons, 2) ? buttons, PAD_L1 : 0;
                        query.response[18] = !test_bit(buttons, 3) ? buttons, PAD_R1 : 0;
                        query.response[19] = !test_bit(buttons, 0) ? buttons, PAD_L2 : 0;
                        query.response[20] = !test_bit(buttons, 1) ? buttons, PAD_R2 : 0;
                    }
                }
