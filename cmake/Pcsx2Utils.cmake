...
function(detectOperatingSystem)
    if(WIN32)
        message(WARNING "Building for Windows using CMake isn't supported, the build will most likely fail")
    ...
    elseif(UNIX)
        ...
        if(CMAKE_SYSTEM_NAME MATCHES "Linux")
            ...
            message(WARNING "Your Unix varient isn't supported, the build will most likely fail")
        endif()
    endif()
endfunction()
