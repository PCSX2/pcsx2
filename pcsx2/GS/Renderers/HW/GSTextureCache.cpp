...
#endif
	{
		...
		for (auto i = list.begin(); i != list.end(); ++i)
		{
			...
			if (t->m_used)
			{
				...
				if (((bp & (GS_BLOCKS_PER_PAGE - 1)) != (t->m_TEX0.TBP0 & (GS_BLOCKS_PER_PAGE - 1))) && (bp & (GS_BLOCKS_PER_PAGE - 1)) && !CanTranslate(bp, bw, psm, block_boundary_rect, t->m_TEX0.TBP0, t->m_TEX0.PSM, t->m_TEX0.TBW))
					continue;
