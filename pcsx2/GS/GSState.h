...
protected:
	...
	void GetTextureMinMaxAxisAlignedHelper(GIFRegTEX0 TEX0, GSVector4i scissor, u32 fst, bool linear, const GSVertex* vertex, u16 index0, u16 index1, GSVector4* minmax);
