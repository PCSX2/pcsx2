...
public:
	...
	void GetSpriteBBox(const GSVertex* const* v, GSVector4* xy_rect, GSVector4* uv_rect);
	template <u32 prim>
	void GetPrimBBox(const GSVertex* const* v, GSVector4* xy_rect, GSVector4* uv_rect);
