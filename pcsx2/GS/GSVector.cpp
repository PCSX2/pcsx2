...
constinit const GSVector4 GSVector4::m_x4b000000 = cxpr(std::bit_cast<float>(0x4b000000));
constinit const GSVector4 GSVector4::m_x4f800000 = cxpr(std::bit_cast<float>(0x4f800000));
