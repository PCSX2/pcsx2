...
void FullscreenUI::DrawPauseMenu(MainWindowType type)
{
			...
			ImVec2(10.0f, 10.0f), ImGuiWindowFlags_NoBackground))
	{
		...
		if (!ImGui::IsPopupOpen(0u, ImGuiPopupFlags_AnyPopup))
		{
			const bool up_pressed = ImGui::Shortcut(ImGuiKey_GamepadDpadUp, ImGuiInputFlags_Repeat) || ImGui::Shortcut(ImGuiKey_UpArrow, ImGuiInputFlags_Repeat);
			const bool down_pressed = ImGui::Shortcut(ImGuiKey_GamepadDpadDown, ImGuiInputFlags_Repeat) || ImGui::Shortcut(ImGuiKey_DownArrow, ImGuiInputFlags_Repeat);
