...
namespace PacketReader::IP::UDP::DHCP
{
	...
	public:
		...
		DHCPopRouter(std::vector<IP_Address> routerIPs);
	...
	public:
		...
		DHCPopDNS(std::vector<IP_Address> dnsIPs);
	...
	public:
		...
		DHCPopREQLIST(std::vector<u8> requestList);
	...
	public:
		...
		DHCPopClientID(std::vector<u8> value);
