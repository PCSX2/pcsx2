...
protected:
	...
	// and armEndBlock() issues one whole-range __builtin___clear_cache over
	// it before it can be. (AetherSX2 does the same — its Link() performs no
	// flush at all, leaving it to the single range flush in armEndBlock.)
