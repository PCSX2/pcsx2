...
// ARM64 port of x86/microVU.h. Program/block management is shared logic, code generation is
// in the arm64 .inl files. Pass 1 (analysis), opcode tables and logging are shared with x86.
...
struct microVU
{
	...
	alignas(16) u32 pqBackup[4]; // Backup for xmmPQ across calls
	...
	// Returns zero when both states are identical.
