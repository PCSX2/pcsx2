...
call :downloadfile "DirectXShaderCompiler-%DXC%.zip" "https://github.com/microsoft/DirectXShaderCompiler/archive/v%DXC%.zip" 54797369a304422f7b98bf0ab1e5824a63190912a99976502f14f6b9b63828b4 || goto error
