...
std::optional<T> StringUtil::FromChars(const std::string_view str, int base)
{
	T value;
...
template std::optional<s32> StringUtil::FromChars(const std::string_view, int);
template std::optional<u32> StringUtil::FromChars(const std::string_view, int);
template std::optional<s64> StringUtil::FromChars(const std::string_view, int);
template std::optional<u64> StringUtil::FromChars(const std::string_view, int);

template <typename T> requires std::is_integral_v<T>
std::optional<T> StringUtil::FromChars(const std::string_view str, int base, std::string_view* endptr)
{
	T value;
...
template std::optional<s32> StringUtil::FromChars(const std::string_view, int, std::string_view*);
template std::optional<u32> StringUtil::FromChars(const std::string_view, int, std::string_view*);
template std::optional<s64> StringUtil::FromChars(const std::string_view, int, std::string_view*);
template std::optional<u64> StringUtil::FromChars(const std::string_view, int, std::string_view*);
...
template std::optional<float>  StringUtil::FromChars(const std::string_view);
template std::optional<double> StringUtil::FromChars(const std::string_view);

template <typename T> requires std::is_floating_point_v<T>
std::optional<T> StringUtil::FromChars(const std::string_view str, std::string_view* endptr)
{
	T value;
...
template std::optional<float>  StringUtil::FromChars(const std::string_view, std::string_view*);
template std::optional<double> StringUtil::FromChars(const std::string_view, std::string_view*);

template <typename T> requires std::is_integral_v<T>
std::string StringUtil::ToChars(T value, int base)
{
...
template std::string StringUtil::ToChars(s32, int);
template std::string StringUtil::ToChars(u32, int);

template <typename T> requires std::is_floating_point_v<T>
std::string StringUtil::ToChars(T value)
{
...
template std::string StringUtil::ToChars(float);
template std::string StringUtil::ToChars(double);
...
bool StringUtil::compareNoCase(const std::string_view str1, const std::string_view str2)
{
...
std::vector<std::string> StringUtil::splitOnNewLine(const std::string& str)
{
...
std::vector<std::string_view> StringUtil::SplitString(const std::string_view str, char delimiter, bool skip_empty /*= true*/)
{
...
std::string StringUtil::ReplaceAll(const std::string_view subject, const std::string_view search, const std::string_view replacement)
{
...
std::string StringUtil::U128ToString(const u128& u)
{
	return fmt::format("0x{:08X}.{:08X}.{:08X}.{:08X}", u._u32[0], u._u32[1], u._u32[2], u._u32[3]);
}

std::string& StringUtil::AppendU128ToString(const u128& u, std::string& s)
{
