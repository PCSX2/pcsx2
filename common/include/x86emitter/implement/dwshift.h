...
struct xImpl_DwordShift
{
	...
	void operator()( const xRegister64& to,	const xRegister64& from, const xRegisterCL& clreg ) const;
	...
	void operator()( const xRegister64& to,	const xRegister64& from, u8 shiftcnt ) const;
    ...
    void operator()( const xIndirectVoid& dest,const xRegister64& from, const xRegisterCL& clreg ) const;
	void operator()( const xIndirectVoid& dest,const xRegister64& from, u8 shiftcnt ) const;
