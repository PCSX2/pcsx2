	...
	DockLayout::Index& index_last_session)
{
	...
	{
		Console.Error("Debugger: Layout file '%s' has invalid 'format' property.", path.c_str());
		result = FAILED;
		return;
	}
	...
	{
		Console.Error("Debugger: Layout file '%s' has invalid 'version_major' property.", path.c_str());
		result = FAILED;
		return;
	}
	...
	{
		Console.Error("Debugger: Layout file '%s' has invalid 'version_minor' property.", path.c_str());
		result = FAILED;
		return;
	}
	...
	{
		Console.Error("Debugger: Layout file '%s' has invalid 'version_hash' property.", path.c_str());
		result = FAILED;
		return;
	}
