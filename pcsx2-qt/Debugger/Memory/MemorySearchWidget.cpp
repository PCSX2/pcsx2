...
void MemorySearchWidget::onListSearchResultsContextMenu(QPoint pos)
{
	...
	if (selection_model->hasSelection())
	{
		...
		connect(menu->addAction(tr("Go to in Disassembly")), &QAction::triggered,
			this, &MemorySearchWidget::contextSearchResultGoToDisassembly);

		QAction* add_to_saved_addresses_action = menu->addAction(tr("Add to Saved Memory Addresses"));
		connect(add_to_saved_addresses_action, &QAction::triggered, this, [list_search_results]() {
