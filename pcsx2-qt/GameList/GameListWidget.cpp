...
void GameListWidget::setCustomBackground(bool force_refresh)
{
	...
	for (size_t i = 0; i < static_cast<u8>(QtUtils::ScalingMode::MaxCount); i++)
	{
	...
	connect(m_background_movie, &QMovie::frameChanged, this, [&]() { processBackgroundFrames(); });
...
void GameListWidget::processBackgroundFrames()
{
	...
	QtUtils::resizeAndPadPixmap(&pm, widget_width, widget_height, dpr, m_background_scaling, m_background_opacity);
