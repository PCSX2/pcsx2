	...
	: SettingsWidget(settings_dialog, parent)
{
	...
	dialog()->registerWidgetHelp(
		...
		tr("Locks the mouse cursor to the windows when PCSX2 is in focus and all other windows are closed.<br>"
		   "<b>Unavailable on Linux Wayland.</b><br><b>Requires accessibility permissions on macOS.</b>"), tr("Unchecked"));
	dialog()->registerWidgetHelp(
	...
	dialog()->registerWidgetHelp(
		m_ui.backgroundScale, tr("Background Image Scaling"),
		tr("Select how to display the background image: <br><br>Fit (Preserve aspect ratio, fit to screen)"
		   ...
		   "<br>Center (Centers the image without any scaling) <br>Tile (Repeat the image to fill the screen)"),
		tr("Fit"));
