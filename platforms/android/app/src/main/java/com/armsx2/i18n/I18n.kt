...
val EN: Map<String, String> = mapOf(
    ...
    "skins.browse.layoutNote" to "Downloaded skins change how the buttons look, not where they are — the layouts in these packs are iOS-only. Use Edit Touch Layout if you want to move them.",
